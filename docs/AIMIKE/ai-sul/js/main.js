        ...
        --------------------------------------*/        
          ...
          if ($("#myPieChart").length !== 0) {
            ...
            var myPieChart = new Chart(ctx,{
                type: 'pie',
                data: {
                    labels: ["Immediate platform development/engineering", "Community reserve", "Public distribution", "Overhead, including management, marketing, business development, operations, advisors"],
                    datasets: [{
                        data: [35, 30, 20, 15],
